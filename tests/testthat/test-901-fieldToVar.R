...
test_that("datetime_ = as.Date returns class Date for datetime_dmy_hm", expect_is(rec_ht$datetime_dmy_hm_test, "Date"))
test_that("datetime_ = as.Date returns class Date for datetime_mdy_hm", expect_is(rec_ht$datetime_mdy_hm_test, "Date"))
test_that("datetime_ = as.Date returns class Date for datetime_ymd_hm", expect_is(rec_ht$datetime_ymd_hm_test, "Date"))
...
test_that("dates = TRUE returns class Date for datetime_dmy_hm", expect_is(rec_dt$datetime_dmy_hm_test, "POSIXt"))
test_that("dates = TRUE returns class Date for datetime_mdy_hm", expect_is(rec_dt$datetime_mdy_hm_test, "POSIXt"))
test_that("dates = TRUE returns class Date for datetime_ymd_hm", expect_is(rec_dt$datetime_ymd_hm_test, "POSIXt"))
...
test_that("dates = TRUE returns 2023-02-24 for date_dmy in first rec",
          expect_true(rec_dt$date_dmy_test[1] == as.POSIXct("2023-02-24")))
test_that("dates = TRUE returns 2023-02-24 for date_mdy in first rec",
          expect_true(rec_dt$date_mdy_test[1] == as.POSIXct("2023-02-24")))
test_that("dates = TRUE returns 2023-02-24 for date_ymd in first rec",
          expect_true(rec_dt$date_ymd_test[1] == as.POSIXct("2023-02-24")))
...
test_that("dates = TRUE returns 2023-02-24 12:40:50 for datetime_mdy_hms in first rec",
          expect_true(rec_dt$datetime_mdy_hms_test[1] ==
                        as.POSIXct("2023-02-24 12:40:50", format="%Y-%m-%d %H:%M:%S")))
test_that("dates = TRUE returns 2023-02-24 12:40:50 for datetime_ymd_hms in first rec",
          expect_true(rec_dt$datetime_ymd_hms_test[1] ==
                        as.POSIXct("2023-02-24 12:40:50", format="%Y-%m-%d %H:%M:%S")))
...
test_that("dates = FALSE returns class character for time_hhmm", expect_is(rec_df$time_hhmm_test, "character"))
test_that("dates = FALSE returns class character for time_mmss", expect_is(rec_df$time_mmss_test, "character"))

test_that("dates = FALSE returns class character for datetime_dmy_hm", expect_is(rec_df$datetime_dmy_hm_test, "character"))
test_that("dates = FALSE returns class character for datetime_mdy_hm", expect_is(rec_df$datetime_mdy_hm_test, "character"))
test_that("dates = FALSE returns class character for datetime_ymd_hm", expect_is(rec_df$datetime_ymd_hm_test, "character"))

test_that("dates = FALSE returns class character for datetime_dmy_hms", expect_is(rec_df$datetime_dmy_hms_test, "character"))
test_that("dates = FALSE returns class character for datetime_mdy_hms", expect_is(rec_df$datetime_mdy_hms_test, "character"))
test_that("dates = FALSE returns class character for datetime_ymd_hms", expect_is(rec_df$datetime_ymd_hms_test, "character"))

test_that("dates = FALSE returns '2023-02-24' for date_dmy first rec",
          expect_true(rec_df$date_dmy_test[1] == "2023-02-24"))
test_that("dates = FALSE returns '2023-02-24' for date_mdy first rec",
          expect_true(rec_df$date_mdy_test[1] == "2023-02-24"))
test_that("dates = FALSE returns '2023-02-24' for date_ymd first rec",
          expect_true(rec_df$date_ymd_test[1] == "2023-02-24"))

# test_that("dates = FALSE returns '12:04:55' for time_hhmmss first rec",
#           expect_true(rec_df$time_hhmmss_test[1] == "12:04:55"))
# test_that("dates = FALSE returns '12:04' for time_hhmm first rec",
#           expect_true(rec_df$time_hhmm_test[1] == "12:04"))
test_that("dates = FALSE returns '02:45' for time_mmss first rec",
          expect_true(rec_df$time_mmss_test[1] == "02:45"))

test_that("dates = FALSE returns '2023-02-24 12:04' for datetime_dmy_hm first rec",
          expect_true(rec_df$datetime_dmy_hm_test[1] == "2023-02-24 12:04"))
test_that("dates = FALSE returns '2023-02-24 12:04' for datetime_mdy_hm first rec",
          expect_true(rec_df$datetime_mdy_hm_test[1] == "2023-02-24 12:04"))
test_that("dates = FALSE returns '2023-02-24 12:04' for datetime_ymd_hm first rec",
          expect_true(rec_df$datetime_ymd_hm_test[1] == "2023-02-24 12:04"))

test_that("dates = FALSE returns 2023-02-24 12:40:50 for datetime_dmy_hms first rec",
          expect_true(rec_df$datetime_dmy_hms_test[1] == "2023-02-24 12:40:50"))
test_that("dates = FALSE returns 2023-02-24 12:40:50 for datetime_mdy_hms first rec",
          expect_true(rec_df$datetime_mdy_hms_test[1] == "2023-02-24 12:40:50"))
test_that("dates = FALSE returns 2023-02-24 12:40:50 for datetime_ymd_hms first rec",
          expect_true(rec_df$datetime_ymd_hms_test[1] == "2023-02-24 12:40:50"))
