...
When it is necessary to cast a zero-coded check field from raw or labeled values, the `castCheckForImport` casting function is the best option, as it provides the user full control over what values are to be considered "Checked."
