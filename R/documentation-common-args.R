...
#'   same named keys are supported as the na argument. The function will be 
#'   provided the variables (x, field_name, coding). The function must return a
#'   vector of logical matching the input length. If `raw_cast` is specified and 
#'   `validation` is left to default it will disable validation to pass all 
#'   values as raw. See [fieldValidationAndCasting()]
