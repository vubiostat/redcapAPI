...
#' 
#' @description These methods enable the user to export survey participants, 
#'   survey access codes, and survey access links.
#'   
...
#' @param record `character(1)` or `integerish(1)`. The record ID for which
#'   the survey information is to be exported.
